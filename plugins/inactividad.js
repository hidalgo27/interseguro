...
function logout() {
  ...
  if (objJWT.common.nuevoProducto == false) {
    if (objJWT.common.email !== null) {
      if (
        objJWT.common.email.includes("test_") ||
        objJWT.common.agent.includes("partner") ||
        objJWT.common.agent.includes("agente") ||
        objJWT.common.agent.includes("externo")
      ) {
...
window.addEventListener("beforeunload", function(e) {
  ...
  if (
    window.location.pathname == "/vehicular/" ||
