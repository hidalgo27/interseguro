      ...
      <div  class="home-banner"  >
        ...
        <div class="home-banner__der" >
            ...
            <div class="box-contador" >
              ...
              <div  class="example  d-none  d-md-flex"  style="flex-direction: column;align-items: flex-end;justify-content: flex-end;position: relative;top: -52px;right: -110px;">
...
import FadeLoader from '@/components/loaders/FadeLoader'
  export default {
    layout: "InterseguroHome",
      ...
      methods: {
        contador(){
            var flipdown2 = new FlipDown(1620622799, 'contadorCyberDesktop').start()
            var flipdown = new FlipDown(1620622799, 'contadorCyberMobile').start()
        },
