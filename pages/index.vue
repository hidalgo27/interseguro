    ...
    <div class="boxHome-banner">      
      <div  class="home-banner"  >
        ...
        <div class="home-banner__der" >
            ...
            <div class="box-contador" >              
              <img src="./../static/media/img/campania/banner-home-desktop.svg" alt="" style="margin-left: 70px;margin-top: 55px;width: 140%;"> 
              ...
              style="flex-direction: column;align-items: flex-end;justify-content: flex-end;position: relative;top: -62px;right: -187px;">                  
