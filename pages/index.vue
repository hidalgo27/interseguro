      ...
      <div  class="home-banner"  >
        ...
        <div class="home-banner__der" >
            ...
            <div class="box-contador" >
              ...
              <div  class="example  d-none  d-md-flex"  style="flex-direction: column;align-items: flex-end;justify-content: flex-end;position: relative;top: -57px;right: 89px;">
  ...
  export default {
    layout: "InterseguroHome",
      ...
      methods: {
        ...
        contador(){
            var flipdown2 = new FlipDown(1623733199, 'contadorCyberDesktop').start()
            var flipdown = new FlipDown(1623733199, 'contadorCyberMobile').start()
        },
