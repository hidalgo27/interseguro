<template>
  <section class="page-cotizador-allRisk" style="background: #f7fafb;">    
    <b-container style="position: relative;">
      <b-row class="justify-content-center" style="position: relative;">
        <b-col cols="11" lg="6">
          <div class="box-steps-allRisk">
            <ul class="steps-allRisk">
              <li class="steps-allRisk__item">Pago</li>
              <li class="steps-allRisk__item">Tu información</li>
              <li class="steps-allRisk__item steps-allRisk--active">Tu carro</li>
              <li class="steps-allRisk--progressBar"></li>
            </ul>
          </div>
        </b-col>
        <b-container>
          <b-row class="d-flex justify-content-center">
            <b-col cols="11" lg="7" class="h-auto">   
              <div class="d-block  d-lg-none" @click="activador()" v-bind:class="{ocultarItemsSeleccionados: ocultarItemsSeleccionados}">
                <div class="itemElegido-allRisk" v-bind:class="{mostrarItemMarca: mostrarItemMarca}">
                  <span>{{this.itemElegido.brand }}</span>
                  <div class="box-close-allRisk" @click="closeMarca()"><img src="../../../static/v2_icon/close_bold.png" alt="x"></div>
                </div>
                <div class="itemElegido-allRisk" v-bind:class="{mostrarItemAnio: mostrarItemAnio}">
                  <span>{{this.itemElegido.year }}</span>
                  <div class="box-close-allRisk" @click="closeAnio()" ><img src="../../../static/v2_icon/close_bold.png" alt="x"></div>
                </div>
                <div class="itemElegido-allRisk" v-bind:class="{mostrarItemModelo: mostrarItemModelo}">
                  <span>{{this.itemElegido.model }}</span>
                  <div class="box-close-allRisk" @click="closeModelo()"><img  src="../../../static/v2_icon/close_bold.png" alt="x"></div>
                </div>
              </div>           
              <div class="activador-allRisk  d-none  d-lg-block" @click="activador()" >
                <div class="itemElegido-allRisk" v-bind:class="{mostrarItemMarca: mostrarItemMarca}">
                  <span>{{this.itemElegido.brand }}</span>
                  <div class="box-close-allRisk" @click="closeMarca()"><img src="../../../static/v2_icon/close_bold.png" alt="x"></div>
                </div>
              ...
              <div class="listas-allRisk">
                <div class="lista1" v-bind:class="{mostrarListaMarca: mostrarListaMarca}">
                  <p class="listas-allRisk--titulo">
                      Selecciona la marca
                    </p>
                  <div class="listas-allRisk--box">
                    <div class="item" v-for="(item, index) in listBrand" :key="index">                    
                      
                      <p v-if="item.name == '----'" class="guiones" style="cursor: auto;">--------------</p>
                      <p v-else @click="seleccionaMarca(item)">{{item.name}}</p>
                    </div>  
                  </div>   
                  <div>
                    <div class="box-btn-allRisk">
                        <span
                          class="backcotizacion"
                          @click="volverHome($event)"
                        >
                          <img
                            width="35"
                ...
                <div class="lista2" v-bind:class="{mostrarListaAnio: mostrarListaAnio}">
                    ...
                    <div class="listas-allRisk--box">
                      <div class="item" v-for="(item, index) in listYear" :key="index">                    
                ...
                <div class="lista2" v-bind:class="{mostrarListaModelo: mostrarListaModelo}">
                    ...
                    <div class="listas-allRisk--box">
                      <div class="item" v-for="(item, index) in listModel" :key="index">                    
        ...
        <b-container>
          <b-row class="d-flex justify-content-center cotizador-allRisk" v-bind:class="{activeBox_2: activeBox_2}">
            <b-col cols="11" lg="6" >
              <b-row>
                  ...
                  <b-row  class="contenedor-primario">
                    <b-col cols="6">
                      <div class="datos-vehiculo-mobile d-block  d-lg-none">
                        <div>
                          <p class="item">{{this.item.plateNumber }}</p>
                        </div>
                        <div>
                          <p class="item"><strong>{{this.itemElegido.brand }} {{this.itemElegido.year }}</strong></p>
                        </div>
                        <div>
                          <p class="item"><strong>{{this.itemElegido.model }}</strong></p>
                        </div>
                        <div>
                          <span @click="resetearVehiculo()" style="text-decoration: underline; color: #007bff;">Editar</span>
                        </div>
                      </div>
                    </b-col>
                    <b-col cols="6" class="d-block  d-lg-none   pr-0  pl-0">
                      <div class="mail-cotizador-allRisk" @click="showModal = showModal != undefined ? true : true">
                        
                        <div class="mail">                          
                            <img src="../../../static/v2_icon/email.png" alt="email">                         
                          <div>
                            <p>Recibe tu <br> cotización</p>
                          </div>
                        </div>
                      </div> 
                      <div class="cotizador-allRisk--vehiculo">
                        
                        <div class="cotizador-allRisk__monto-mensual">
                          <p class="cotizador-allRisk__monto-mensual--item">$ <span>{{this.listCotizacion.policy.monthly}}</span> /MES</p>
                          <span class="cotizador-allRisk__monto-anual--item">Anual: ${{this.listCotizacion.policy.annual}}</span>
                        </div>
                      </div>
                    </b-col>
                    <b-col cols="12" lg="8">
                      <div class="cotizador-allRisk__suma-asegurada">
                        <p>Suma asegurada :  <span class="monto-actual">$ {{this.clonado.vehicle.current}}</span></p>
                        <div class="cotizador-allRisk__suma-asegurada--box">
                          <div class="box-range">                                                
                      ...
                      <div class="cotizador-allRisk__cobertura">
                        <div>
                          <span class="ml-4"> 
                            <a href="javascript:void(0);" v-if="this.listCotizacion.vehicle.gps == 'Y'" @click="showModalGPS()"> 
                ...
                <br>
                <b-col cols="12" class="contenedor-secundario  mt-2">
                  <div class="lista">
                    <div class="item">
                ...
                <b-col cols="12 pr-0">
                  <div class="box-btn-allRisk">
                    ...
                    <button
                      ...
                      class="btn box-btn-allRisk__button box-btn-allRisk--dni"
                    >continuar</button>
                  </div>
                </b-col>
              </b-row>
    ...
    >
      <div class="modal-content fechaVigenciacotizador-allRisk">
        <b-btn
          class="mt-3 modal-close"
        ...
        <div class="modal-body">
          <div>
            <div id="input-group-3" class="inicioVigencia">
              ...
              <div class="fechacotizador-allRisk">                
            ...
            <div id="etiqueton" class="endosoSesion">
              <div v-for="(item, index) in listaNuevaDeEndoso" :key="index">
                <div v-on:click="setearEntidadFinanciera(item)">
                  <div id="etiquetin" class="endosoItem">
                    <span
                      name="parent"
    ...
    <b-modal
      ...
      size="lg"
    >
      <div class="modal-content modal-endoso">
        <b-btn
          class="mt-3 modal-close"
          @click="hideModalEndoso()"
          style="background: white; border: none;"
        >
          <img
            src="../../../static/media/img/flujo/cotizacion/modal-close.svg"
        ...
        <div class="modal-head">
          <div class="box-titulo">
            <h2 class>PASOS PARA ENDOSAR MI PÓLIZA</h2>
          </div>
          <div class="modal-divider"></div>
        </div>
        <div class="modal-body">
          <div class="modal-body__item">
            <div class="box-img">
              <img
                src="../../../static/media/img/flujo/cotizacion/paso1_endoso.svg"
                alt="pasos endoso"
              />
            </div>
            <div class="box-paso">
            ...
            <div class="box-descripcion">
              <p>Descarga y completa la plantilla que encontrarás al finalizar tu compra.</p>
            </div>
          </div>
          <div class="modal-body__item">
            <div class="box-img">
              <img
                src="../../../static/media/img/flujo/cotizacion/paso2_endoso.svg"
                alt="pasos endoso"
              />
            </div>
            <div class="box-paso">
            ...
            <div class="box-descripcion">
              <p>Firma y adjunta la foto de tu plantilla y DNI (por ambos lados).</p>
            </div>
          </div>
          <div class="modal-body__item">
            <div class="box-img">
              <img
                src="../../../static/media/img/flujo/cotizacion/paso3_endoso.svg"
                alt="pasos endoso"
              />
            </div>
            <div class="box-paso">
            ...
            <div class="box-descripcion">
              <p>
                EnvÍa lo solicitado en
                <br />5 días útiles a segurovehicular@interseguro.com.pe
              </p>
            </div>
          </div>
        </div>
    ...
    >
      <div class="modal-content modal-endoso">
        ...
        <div class="modal-head">
          <div class="box-titulo">
            <h2 class>PASOS PARA LLEVARTE UN SMART TV 4K</h2>
          </div>
          <div class="modal-divider"></div>
        </div>
        <div class="modal-body">
          <div class="modal-body__item">
            <div class="box-img">
              <img
                src="../../../static/media/img/flujo/cotizacion/paso1_tv.png"
                alt="pasos smart tv"
              />
            </div>
            <div class="box-paso">
            ...
            <div class="box-descripcion">
              <p>Elige la opción "plan 2 años" en el último paso de la compra.</p>
            </div>
          </div>
          <div class="modal-body__item">
            <div class="box-img">
              <img
                src="../../../static/media/img/flujo/cotizacion/paso2_tv.png"
                alt="pasos smart tv"
              />
            </div>
            <div class="box-paso">
            ...
            <div class="box-descripcion">
              <p>Realiza la evaluación vehicular de manera digital.</p>
            </div>
          </div>
          <div class="modal-body__item">
            <div class="box-img">
              <img
                src="../../../static/media/img/flujo/cotizacion/paso3_tv.png"
                alt="pasos smart tv"
              />
            </div>
            <div class="box-paso">
    ...
    <b-modal id="leaveQuote" class="leaveModal" size="lg"  static centered hide-footer hide-header>
      <b-container>
        ...
        <b-row class="text-center">
          ...
          <b-col cols="12" class="mb-3">
            <h3>Protege tu {{this.itemElegido.brand}} con los mejores <br> precios, desde ${{this.listCotizacion.policy.monthly}}. </h3>
          </b-col>
    ...
    <b-modal id="leaveQuote2" class="leaveModal" size="lg"  static centered hide-footer hide-header>
      <b-container>
        ...
        <b-row class="text-center">
          ...
          <b-col cols="12" class="mb-3">
            <h3>Elige un plan para tu {{this.itemElegido.brand}} <br> desde ${{this.listCotizacion.policy.monthly}} y maneja seguro</h3>
          </b-col>
          <b-col cols="12" class="mb-2">
  ...
  export default {
    ...
    methods: {
      ...
      detectarkey(e){
        ...
        let listaMarcas = this.listBrand.filter((item) =>{
          return item.group == 2
        })       
...
.listas-allRisk{
  &--box{   
    ...
    overflow: scroll;
    border-radius: 8px;
    box-shadow: rgba(0, 0, 0, 0.08) 0px 2px 10px 0px, rgba(0, 0, 0, 0.12) 0px 2px 4px 0px;
    &::-webkit-scrollbar {
...
.box-btn-allRisk__button.box-btn-allRisk--back {
  padding-left: 0;
  padding: 0;
  width: 170px;
}
