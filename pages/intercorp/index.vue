<template>
  <div class="home  home-intercorp"  v-bind:class="{'mt-5': this.$store.state.common.flagCloseListon == 0  }">
    <!-- Facebook Pixel Code -->
...
<!-- End Facebook Pixel Code -->
    ...
    <div class="home-beneficios2  p-47px">
      ...
      <div class="home-beneficios2__cuerpo  beneficios2 d-lg-flex">
        ...
        <div class="beneficios2__item">
          <div class="img-box">
            <img src="./../../static/media/interseguroVehicular_v2/intercorp-2.svg" alt="gruas">
          </div>
          <div class="beneficios-desc">
        ...
        <div class="beneficios2__item">
          <div class="img-box">
            <img src="./../../static/media/interseguroVehicular_v2/intercorp-3.svg" alt="mecanico">
          </div>
          <div class="beneficios-desc">
            <p class="beneficios-titulo">
              Auxilio mecánico
        ...
        <div class="beneficios2__item">
          <div class="img-box">
            <img src="./../../static/media/interseguroVehicular_v2/intercorp-4.svg" alt="">
          </div>
          <div class="beneficios-desc">
            <p class="beneficios-titulo">
...
@keyframes listonMobile {
  ...
  .box-flotante-covid .box-contador {
    ...
    .formCotizador{
      ...
      .box-btn-homeForm{
        button{
          border-color: #FF0773!important;
          background-color: #FF0773!important;
          max-width: 360px;
          width: 100%;
          height: 51px;
          margin: 0 auto!important;
  ...
  .home-intercorp .home-pasos .plan--cuerpo .incluye {
    font-family: 'Montserrat Medium';
}

  @media (min-width: 600px) {
    .home-intercorp .home-pasos {
        padding-top: 40px;
    }
  }
  ...
  @media (min-width: 1440px) {
    .home-intercorp .boxHome-banner .home-banner {
        max-width: 1200px;
    }
    .home-intercorp{
      .boxHome-banner{              
