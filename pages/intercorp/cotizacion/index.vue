            ...
            <b-col cols="11" lg="7" class="h-auto">   
              ...
              <div class="listas">
                <div class="lista1" v-bind:class="{mostrarListaMarca: mostrarListaMarca}">
                  ...
                  <p class="listas--titulo mt-2  mb-2" style="color: #005DAB;">
                      Selecciona la marca
                    </p>
                ...
                <div class="lista2" v-bind:class="{mostrarListaAnio: mostrarListaAnio}">
                    <p class="listas--titulo  mt-3  mb-3" style="color: #005DAB;"> 
                      Selecciona el año
                    </p>
                    <div class="listas--box">
            ...
            <div class="v2-planes">
              <div class="row  mb-4">
                <div class="col-12  col-lg-6">
                  <p class="v2-planes--titulo" style="color: #005DAB;"> 
                    Selecciona tu plan
                  </p>
                </div>
              ...
              <table class="table-planes">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="check-table" style="color:#005DAB">&#x2714;	</td>
                  </tr>
                  <tr>
          ...
          <b-row class="justify-content-center">
            <b-col class="text-center mb-3" cols="12">
              ...
              <p class="mt-3">
                ...
                <strong style="color : #333333; font-size: 30px">¡Solo por pocos días! </strong> <br> <br> 
