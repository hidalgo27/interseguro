                ...
                <b-row class="d-flex  justify-content-center">
                    <b-col cols="12" lg="6">
                        <div class="card-datos__titulo">
                            ...
                            <p class="card-datos--subtitulo">Actualiza tu tarjeta en un minuto</p>                      
                        </div>
                        ...
                        <div class="card-valorComercial  bg-white  mt-3">
                            ...
                            <div>
                                <span class="check">&#10004;</span> Suma asegurada :  <span class="monto-actual">$ {{listCotizacion.vehicle.current}}</span>
                            ...
                            <div>
                                <p>
                                   <span class="check">&#10004;</span>Tarjeta {{this.objRenovacion.card.brand}}
                                    <span>{{this.objRenovacion.card.number}}</span>
                                </p>
                            </div>
                        ...
                        <div class="card-pagoAct ">
                            <div class="card-pagoAct__tarjeta">
                                <p class="titulo-seccion">Recuerda</p>
                                <p>Actualizar tu tarjeta para regularizar tu pago o <br> para evitar problemas co tu afiliación</p>
                               
                            </div>
                            
                        </div>
                        <div class="card-btn">
                            <button @click="actualizarTarjeta()">Actualizar tarjeta</button>
                    ...
                    <div class="panel-custom pt-3 pb-0">
                        <form class="card-interseguro">   
                            <div class="form-group-custom">                                                        
                                <span class="card-interseguro__titulo">Ingresa tu tarjeta de débito o crédito </span>
                                <div class="imgs" >                                    
                                    <span class="card-interseguro__subtitulo">Pago online 100% seguro</span>
                                    <div class="tarjetas">
                                        ...
                                        <span><img width="25" src="../../static/media/img/flujo/metodo-pago/dinners.png" alt="dinners"></span>
                                    </div>                                                    
                                </div>
                        ...
                        <button type="submit" @click="continuar" class="btn-actualizar" >
                            ACTUALIZAR
                        </button>
                    </div>
                </div>
                ...
                this.$store.dispatch('common/obtenerDatos', this.placa).then((res) =>{          
                    if (res.data.code == 0) {
                        ...
                        if (this.objRenovacion.policy.renew == "Y") {
                                localStorage.removeItem("placaNoRenovar")
                            ...
                            localStorage.setItem("placaNoRenovar", this.objRenovacion.vehicle.plateNumber)
...
/******************************************************************************************************* */
    ...
    #cardnumber, #cardmes, #cardaño,#cardccv{
