                        ...
                        <div class="telefono ">
                            <a target="_blank" style="text-decoration: none;" href="https://api.whatsapp.com/send?phone=51977822185&amp;text=Hola!%20Estoy%20en%20la%20web%20de%20Seguro%20Vehicular%20y%20tengo%20una%20consulta.%20">                              
                                ...
                                <div class="d-flex  wapp-desktop">
                                    ...
                                    <div>
                                        <span @click="ga_click_wsapp()" style="text-align:left; display: flex" class="ml-2">Escríbenos<br>977 822 185</span>
                                    </div>
                                </div>
                            </a>
    ...
    methods:{
        ga_click_wsapp(){
            if (document.location.hostname == "www.interseguro.pe"){
                fbq('track', 'Contact', {
                    contactar_whatsapp: 'ContactarWhatsapp'
                });
            }else{
            }
            ...
            window.dataLayer.push({
                ...
                description: "Click en el boton de whatsapp en el header IS Cotizador"
            });
        },
        closeListon(){
