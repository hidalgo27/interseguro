        ...
        <div>
            <div id="liston-desktop" class="liston" v-bind:class="{'d-none': flagCloseListon == 0  }">
                <div class="box-img-liston">
                    <img class="img-liston" src="../../static/media/img/promocion.png" alt=""> 
                </div>
                <p> ¡Gana sin sorteos un vale virtual de consumo de <span v-if="this.urlLocal == '/promocion100'">S/100</span><span v-else-if="this.urlLocal == '/promocion50'">S/50</span> por la compra de tu seguro vehicular entre el 13 y 18 de octubre!  
                    <a style="text-decoration:underline; color: #fff" href="https://www.interseguro.pe/vehicular/tyc/"> Ver más info</a>
